...
export const OrderTracking = () => {
  ...
  const handleMessageDriver = () => {
    toast.info('پیام شما برای راننده ارسال شد');
  };
          ...
          <Card className="border-primary">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-1 text-sm">
                    ...
                    <span className="text-muted-foreground">• {driver.totalTrips} سفر</span>
                  </div>
                </div>
              </div>
              ...
              <div className="grid gap-2">
                ...
                <Button variant="outline" onClick={handleMessageDriver} className="gap-2">
              ...
              <ScrollArea className="h-[200px]">
                <div className="space-y-3 text-sm">
                  <div className="flex gap-2">
                    ...
                    <p>موقعیت راننده هر 5 ثانیه به‌روزرسانی می‌شود</p>
                  </div>
                  <div className="flex gap-2">
                    <CheckCircle className="mt-0.5 h-4 w-4 flex-shrink-0 text-green-500" />
