...
const mockDrivers: Driver[] = [
  {
    ...
    priority: 1,
    currentLocation: { lat: 35.6892, lng: 51.3890 },
...
const mockOrders: Order[] = [
  ...
  },
  {
    ...
    destinationAddress: {
      ...
      userId: 'c3',
      title: 'انبار',
      fullAddress: 'تهران، منطقه 12، اتوبان تهران-کرج',
      lat: 35.7219,
      lng: 51.2456,
      district: '12',
      city: 'تهران',
          ...
          <Tabs defaultValue="personal" className="w-full">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Textarea
                    ...
                    placeholder="تهران، منطقه 5، خیابان آزادی"
                    rows={3}
                  />
                </div>
              </div>
            ...
            <TabsContent value="documents" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="insuranceImage">تصویر بیمه‌نامه</Label>
                  <div className="flex gap-2">
                    <Input
                      id="insuranceImage"
