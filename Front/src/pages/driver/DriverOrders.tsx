...
const statusColors: Record<OrderStatus, string> = {
  ...
  [OrderStatus.DRIVER_ASSIGNED]: 'bg-blue-100 text-blue-700',
  ...
  [OrderStatus.REVIEWING]: 'bg-orange-100 text-orange-700',
  [OrderStatus.CONFIRMED]: 'bg-cyan-100 text-cyan-700',
  [OrderStatus.DRIVER_EN_ROUTE_TO_ORIGIN]: 'bg-indigo-100 text-indigo-700',
  [OrderStatus.PACKING_IN_PROGRESS]: 'bg-pink-100 text-pink-700',
  [OrderStatus.LOADING_IN_PROGRESS]: 'bg-teal-100 text-teal-700',
  [OrderStatus.ARRIVED_AT_DESTINATION]: 'bg-lime-100 text-lime-700',
};

const statusLabels: Record<OrderStatus, string> = {
  [OrderStatus.PENDING]: 'در انتظار پذیرش',
