...
import { Menu, User, Phone, LogIn, LayoutDashboard, Package, MapPin, LogOut } from 'lucide-react';
                ...
                <DropdownMenuContent align="end" className="w-56" dir="rtl">
                  ...
                  {isCustomer && (
                    <>
                      ...
                      <DropdownMenuItem onClick={() => navigate('/customer/addresses')} className="cursor-pointer justify-end">
                  ...
                  <>
                    ...
                    {isCustomer && (
                      <>
                        ...
                        <Link to="/customer/addresses" className="text-lg hover:text-primary transition-colors flex items-center gap-2 justify-end">
                          <span>آدرس‌های من</span>
