...
import { PackingType, PackingItem, SelectedPackingProduct } from '../../types';
import { useState } from 'react';
import { Checkbox } from '../ui/checkbox';
import { Plus, Minus, ShoppingCart, UserRound, ArrowRight } from 'lucide-react';
import { mockPackingProducts } from '../../services/mockData';
...
export const PackingStep = ({
  ...
  const handleProductQuantityChange = (productId: string, change: number) => {
    const product = mockPackingProducts.find((p) => p.id === productId);
    if (!product) return;
              ...
              <div className="space-y-4 pr-8">
                ...
                {packingMaterialsMode === 'manual' && (
                  <div className="space-y-4 mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {mockPackingProducts.map((product) => {
