...
import { Order, OrderStatus, VehicleType, Driver } from '../../types';
...
export default function AdminOrders() {
  ...
  const getOrderStatusLabel = (status: OrderStatus) => {
    const labels: Record<OrderStatus, string> = {
      ...
      [OrderStatus.ASSIGNED]: 'اختصاص داده شده',
      ...
      orders.map((o) =>
        o.id === selectedOrder.id
          ? {
              ...
              status: o.status === OrderStatus.PENDING ? OrderStatus.ASSIGNED : o.status,
            }
          : o
      )
    );
  ...
  const confirmChangeStatus = () => {
    ...
    setOrders(
      orders.map((o) => (o.id === selectedOrder.id ? { ...o, status: selectedStatus } : o))
    );
            ...
            <div className="space-y-2">
              ...
              <Select value={statusFilter} onValueChange={(value: any) => setStatusFilter(value)}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value={OrderStatus.ASSIGNED}>اختصاص داده شده</SelectItem>
                      ...
                      <div className="rounded-lg border p-4">
                        <div className="mb-2 flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <div className="font-medium">
                              {selectedOrder.destinationAddress.title}
                            </div>
                          </div>
                        </div>
                        <p className="mr-10 text-sm text-muted-foreground">
                ...
                <div className="rounded-lg border bg-muted/50 p-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="mr-2 font-medium">{driver.totalTrips} سفر</span>
                    </div>
                  </div>
                </div>
              ) : null;
