...
export const CustomerOrders = () => {
  ...
  const renderOrderCard = (order: Order) => {
    ...
    const canTrack =
      order.status === OrderStatus.ASSIGNED || order.status === OrderStatus.IN_PROGRESS;
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2 text-sm">
                ...
                <div>
                  <div className="font-medium">{order.originAddress.title}</div>
              ...
              <div className="flex items-start gap-2 text-sm">
                ...
                <div>
                  <div className="font-medium">{order.destinationAddress.title}</div>
                  ...
                  <div className="space-y-3">
                    <div className="rounded-lg border p-3">
                      <div className="mb-2 flex items-center gap-2">
                        ...
                        <span className="font-medium">{selectedOrder.originAddress.title}</span>
                      </div>
                    ...
                    <div className="rounded-lg border p-3">
                      <div className="mb-2 flex items-center gap-2">
                        ...
                        <span className="font-medium">{selectedOrder.destinationAddress.title}</span>
                      </div>
                      <p className="mr-6 text-sm text-muted-foreground">
